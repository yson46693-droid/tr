...
<body>
    ...
    <div class="statement-wrapper">
        ...
        <div class="summary-section">
            ...
            <div class="summary-row" style="background: linear-gradient(135deg, #fee2e2 0%, #fecaca 100%); padding: 16px; border-radius: 8px; margin-bottom: 12px; border: 2px solid #dc2626;">
                <span class="summary-label" style="font-weight: 700; color: #991b1b;">اجمالي السلف</span>
                <span class="summary-value amount-negative" style="font-size: 18px; font-weight: 700; color: #dc2626;"><?php echo formatCurrency($totalAdvances); ?></span>
            </div>
