...
<head>
    ...
    <style>
        ...
        /* Professional Loading Overlay - شاشة تحميل احترافية */
        ...
        #professionalLoadingOverlay .spinner-ring {
            position: absolute;
            width: 100%;
            height: 100%;
        ...
        #professionalLoadingOverlay .spinner-ring:nth-child(2) {
            width: 90%;
            height: 90%;
            top: 5%;
            left: 5%;
        ...
        #professionalLoadingOverlay .spinner-ring:nth-child(3) {
            width: 70%;
            height: 70%;
            top: 15%;
            left: 15%;
        ...
        #professionalLoadingOverlay .spinner-center {
            position: absolute;
            top: 50%;
            left: 50%;
    ...
    <!-- Professional Loading Overlay HTML - فقط للمستخدمين المسجلين -->
    <?php if (isLoggedIn()): ?>
    <div id="professionalLoadingOverlay" aria-hidden="true" role="status" aria-label="جاري التحميل">
