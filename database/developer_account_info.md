...
- **البريد الإلكتروني (Email):** `developer@company.com`
- **كلمة المرور الافتراضية:** `password`
- **الدور (Role):** `developer`
- **الاسم الكامل:** `حساب المطور`
- **الحالة:** `active` (نشط)
...
2. **الوصول إلى لوحة المدير:**
   - يمكن لحساب المطور الوصول إلى جميع صفحات لوحة المدير (`dashboard/manager.php`)
